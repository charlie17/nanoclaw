        ...
        (proxyRes) => {
          ...
          if (isHtmlResponse) {
            ...
            proxyRes.on('end', () => {
              ...
              const link =
                '<a href="/" style="position:fixed;bottom:12px;right:12px;z-index:9999;background:rgba(0,0,0,0.75);color:#fff;padding:6px 12px;border-radius:6px;text-decoration:none;font-size:12px;font-family:-apple-system,sans-serif;box-shadow:0 2px 8px rgba(0,0,0,0.3)">&larr; Daystrom</a>';
